class PostsController < ApplicationController
  ...
  def post_params
  	params.require(:post).permit(:user_id, :genre_id, :poster, :poster_cache, :title, :description, :embed, :imdbID, :year, :rated, :released, :runtime, :director, :writer, :actors, :plot, :language, :country, :awards, :poster, :metascore, :imdbrating, :imdbvotes, :header_image, :header_image_cache, :featured, :trailer, :gallery_image_1, :gallery_image_1_cache, :gallery_image_2, :gallery_image_2_cache, :gallery_image_3, :gallery_image_3_cache)
  end
end
